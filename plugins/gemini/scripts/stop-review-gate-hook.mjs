...
function main() {
  ...
  if (!availability.available) {
    const reason = `The stop-time review gate is enabled, but the Gemini CLI is unavailable: ${availability.detail}. Run /gemini:setup to fix or /gemini:setup --disable-review-gate to turn the gate off.`;

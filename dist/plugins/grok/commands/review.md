...
Run a Grok review through the shared plugin runtime.
...
- `/grok:review` runs a structured review and returns JSON. It does not support staged-only review, unstaged-only review, or extra focus text.
